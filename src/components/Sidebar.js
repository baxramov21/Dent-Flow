...
import { LayoutDashboard, Users, Calendar, ClipboardList, BriefcaseMedical, Settings, Clock, History, Sparkles, PieChart, Bell } from 'lucide-react'
...
export default function Sidebar() {
  ...
  const managementLinks = [
    ...
    { href: '/notifications', label: 'Xabarnomalar', icon: Bell },
    ...(permissions?.canManageStaff ? [{ href: '/finances', label: 'Moliya', icon: PieChart }] : []),
